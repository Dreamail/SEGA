...
class AuthLog
{
     ...
     */
    public static function save($gameId, $ver, $serial, $globalIp, $result, $cause, $placeId, $countryCode,
                                $allNetId, $placeIp, $request, $response, $debugInfo, $placeDebugInfo)
    {
        ...
        $params = array($serial, $result, $cause, $gameId, $ver, $placeId, $countryCode, $placeIp, $globalIp, $allNetId,
            $request, $response, $debugInfo, $placeDebugInfo, DB_CREATE_USER_ID);
        LogUtil::sqlLog("[認証ログ:登録]"
            . " query=" . $query
            . " param=(" . $serial . ", " . $result . ", " . $cause . ", " . $gameId . ", " . $ver . ", " . $placeId . ", " . $countryCode . ", " . $placeIp . ", " . $globalIp . ", " . $allNetId
            . ", " . $request . ", " . $response . ", " . $debugInfo . ", " . $placeDebugInfo . ", " . DB_CREATE_USER_ID . ")");
        try {
