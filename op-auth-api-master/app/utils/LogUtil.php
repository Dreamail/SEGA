...
class LogUtil
{
     ...
     * @param $message
     */
    public static function activateApiLog($message, $loglevel = 'INFO')
    {
        file_put_contents(LogUtil::getLogFile(ACTIVATE_API_LOG),
            LogUtil::getMessage($loglevel, debug_backtrace(), $message), FILE_APPEND);
    }

    /**
     * DeliveryInstructionApiログ出力
     * @param $message
     */
    public static function deliveryInstructionApiLog($message, $loglevel = 'INFO')
    {
