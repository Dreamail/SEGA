...
public class MachineTable extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            // 開始ログを出力
            _log.info(logUtils.formatStartLog("MachineTable"));

            MachineTableService service = _context.getBean(
                    "machineTableService", MachineTableService.class);

            // 基板情報取得処理
            String ret = service.machineTable(req.getParameter("id"),
                    req.getParameter("pw"),
            ...
            // 終了ログを出力
            _log.info(logUtils.formatFinishLog("MachineTable", interrupt));
        }
    }
}
