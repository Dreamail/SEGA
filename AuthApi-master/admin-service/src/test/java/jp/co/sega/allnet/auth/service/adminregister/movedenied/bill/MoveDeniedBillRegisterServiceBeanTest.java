...
@Rollback(true)
public class MoveDeniedBillRegisterServiceBeanTest {

    private static final Logger _log = LoggerFactory
            .getLogger(MoveDeniedBillRegisterServiceBeanTest.class);

    @PersistenceContext
    private EntityManager _em;

    @Resource(name = "moveDeniedBillRegisterService")
    private MoveDeniedBillRegisterService _service;
     ...
     */
    @Test
    public final void testRegisterMoveDeniedBill() throws IOException {
        // 登録成功
        ...
        createMoveDeniedBill(map2.get("billCode"));
        createMoveDeniedBill(map4.get("billCode"));

        _em.flush();

        // MoveDeniedBillRegisterServiceで使用するメソッドの振る舞いを設定
        ...
        String ret = _service.registerMoveDeniedBill(val);
        _log.info(ret);
        _em.flush();
        ...
        // 同一包括先内自動移設不許可請求先情報のDB確認
        MoveDeniedBill b = _em.find(MoveDeniedBill.class, map1.get("billCode"));

        assertEquals(map1.get("billCode"), b.getBillCode());
        assertEquals(mockUserId, b.getCreateUserId());

        b = _em.find(MoveDeniedBill.class, map2.get("billCode"));

        assertNull(b);

        b = _em.find(MoveDeniedBill.class, map3.get("billCode"));

        assertNull(b);

        b = _em.find(MoveDeniedBill.class, map4.get("billCode"));

        assertEquals("TestUserCreate", b.getCreateUserId());

        b = _em.find(MoveDeniedBill.class, map5.get("billCode"));

        assertNull(b);

        b = _em.find(MoveDeniedBill.class, map6.get("billCode").toUpperCase());
     ...
     */
    @Test
    public void testRegisterMoveDeniedBillInvalidParameterCompCodeIsEmpty()
            throws IOException {
        Map<String, String> map1 = new HashMap<String, String>();
        map1.put("billCode", "");
        map1.put("registerFlag", "1");
     ...
     */
    @Test
    public void testRegisterMoveDeniedBillInvalidParameterCompCodeIsInvalidSize()
            throws IOException {
        Map<String, String> map1 = new HashMap<String, String>();
     ...
     */
    @Test
    public void testRegisterMoveDeniedBillInvalidParameterCompCodeIsInvalidLetter()
            throws IOException {
        Map<String, String> map1 = new HashMap<String, String>();
     ...
     */
    @Test
    public void testRegisterMoveDeniedBillInvalidParameterRegisterFlagIsEmpty()
            throws IOException {
        Map<String, String> map1 = new HashMap<String, String>();
        map1.put("billCode", "2Z9901001");
     ...
     */
    @Test
    public void testRegisterMoveDeniedBillInvalidParameterRegisterFlagIsInvalidLetter()
            throws IOException {
        Map<String, String> map1 = new HashMap<String, String>();
        map1.put("billCode", "2Z9901001");
    ...
    private MoveDeniedBill createMoveDeniedBill(String billCode) {
        MoveDeniedBill b = _em.find(MoveDeniedBill.class, billCode);
        if (b != null) {
            return b;
        }
        b = new MoveDeniedBill();
        b.setBillCode(billCode);
        b.setCreateDate(new Date());
        b.setCreateUserId("TestUserCreate");
        _em.persist(b);
