...
@Rollback(true)
public class MoveDeniedGameCompRegisterServiceBeanTest {

    private static final Logger _log = LoggerFactory
            .getLogger(MoveDeniedGameCompRegisterServiceBeanTest.class);

    @PersistenceContext
    private EntityManager _em;

    @Resource(name = "moveDeniedGameCompRegisterService")
    private MoveDeniedGameCompRegisterService _service;
     ...
     */
    @Test
    public final void testRegisterMoveDeniedGameComp() throws IOException {
        // 登録成功
        ...
        createMoveDeniedGameComp(map2.get("compCode"), map2.get("gameId"));
        createMoveDeniedGameComp(map4.get("compCode"), map4.get("gameId"));

        _em.flush();

        // MoveDeniedGameCompRegisterServiceで使用するメソッドの振る舞いを設定
        ...
        String ret = _service.registerMoveDeniedGameComp(val);
        _log.info(ret);
        _em.flush();
        ...
        pk = new MoveDeniedGameCompPK();
        pk.setCompCode(map2.get("compCode"));
        pk.setGameId(map2.get("gameId"));
        c = _em.find(MoveDeniedGameComp.class, pk);
     ...
     */
    @Test
    public void testRegisterMoveDeniedGameCompInvalidParameterCompCodeIsEmpty()
            throws IOException {
        Map<String, String> map1 = new HashMap<String, String>();
        map1.put("compCode", "");
        map1.put("gameId", "SBXX");
     ...
     */
    @Test
    public void testRegisterMoveDeniedGameCompInvalidParameterCompCodeIsInvalidSize()
            throws IOException {
        Map<String, String> map1 = new HashMap<String, String>();
     ...
     */
    @Test
    public void testRegisterMoveDeniedGameCompInvalidParameterCompCodeIsInvalidLetter()
            throws IOException {
        Map<String, String> map1 = new HashMap<String, String>();
     ...
     */
    @Test
    public void testRegisterMoveDeniedGameCompInvalidParameterGameIdIsEmpty()
            throws IOException {
        Map<String, String> map1 = new HashMap<String, String>();
        map1.put("compCode", "2Z9901");
        map1.put("gameId", "");
     ...
     */
    @Test
    public void testRegisterMoveDeniedGameCompInvalidParameterGameIdIsInvalidSize()
            throws IOException {
        Map<String, String> map1 = new HashMap<String, String>();
        map1.put("compCode", "2Z9901");
     ...
     */
    @Test
    public void testRegisterMoveDeniedGameCompInvalidParameterGameIdIsInvalidLetter()
            throws IOException {
        Map<String, String> map1 = new HashMap<String, String>();
        map1.put("compCode", "2Z9901");
        map1.put("gameId", "エラー");
     ...
     */
    @Test
    public void testRegisterMoveDeniedGameCompInvalidParameterRegisterFlagIsEmpty()
            throws IOException {
        Map<String, String> map1 = new HashMap<String, String>();
        map1.put("compCode", "2Z9901");
        map1.put("gameId", "SBXX");
     ...
     */
    @Test
    public void testRegisterMoveDeniedGameCompInvalidParameterRegisterFlagIsInvalidLetter()
            throws IOException {
        Map<String, String> map1 = new HashMap<String, String>();
        map1.put("compCode", "2Z9901");
        map1.put("gameId", "SBXX");
    ...
    private MoveDeniedGameComp createMoveDeniedGameComp(String compCode,
            String gameId) {
