...
@Rollback(true)
public class MoveDeniedGameBillRegisterServiceBeanTest {

    private static final Logger _log = LoggerFactory
            .getLogger(MoveDeniedGameBillRegisterServiceBeanTest.class);

    @PersistenceContext
    private EntityManager _em;

    @Resource(name = "moveDeniedGameBillRegisterService")
    private MoveDeniedGameBillRegisterService _service;
     ...
     */
    @Test
    public final void testRegisterMoveDeniedGameBill() throws IOException {
        // 登録成功
        ...
        createMoveDeniedGameBill(map2.get("billCode"), map2.get("gameId"));
        createMoveDeniedGameBill(map4.get("billCode"), map4.get("gameId"));

        _em.flush();

        // MoveDeniedGameBillRegisterServiceで使用するメソッドの振る舞いを設定
        ...
        String ret = _service.registerMoveDeniedGameBill(val);
        _log.info(ret);
        _em.flush();
        ...
        pk = new MoveDeniedGameBillPK();
        pk.setBillCode(map2.get("billCode"));
        pk.setGameId(map2.get("gameId"));
        c = _em.find(MoveDeniedGameBill.class, pk);
     ...
     */
    @Test
    public void testRegisterMoveDeniedGameBillInvalidParameterCompCodeIsEmpty()
            throws IOException {
        Map<String, String> map1 = new HashMap<String, String>();
        map1.put("billCode", "");
        map1.put("gameId", "SBXX");
     ...
     */
    @Test
    public void testRegisterMoveDeniedGameBillInvalidParameterCompCodeIsInvalidSize()
            throws IOException {
        Map<String, String> map1 = new HashMap<String, String>();
     ...
     */
    @Test
    public void testRegisterMoveDeniedGameBillInvalidParameterCompCodeIsInvalidLetter()
            throws IOException {
        Map<String, String> map1 = new HashMap<String, String>();
     ...
     */
    @Test
    public void testRegisterMoveDeniedGameBillInvalidParameterGameIdIsEmpty()
            throws IOException {
        Map<String, String> map1 = new HashMap<String, String>();
        map1.put("billCode", "2Z9901001");
        map1.put("gameId", "");
     ...
     */
    @Test
    public void testRegisterMoveDeniedGameBillInvalidParameterGameIdIsInvalidSize()
            throws IOException {
        Map<String, String> map1 = new HashMap<String, String>();
        map1.put("billCode", "2Z9901001");
     ...
     */
    @Test
    public void testRegisterMoveDeniedGameBillInvalidParameterGameIdIsInvalidLetter()
            throws IOException {
        Map<String, String> map1 = new HashMap<String, String>();
        map1.put("billCode", "2Z9901001");
        map1.put("gameId", "エラー");
     ...
     */
    @Test
    public void testRegisterMoveDeniedGameBillInvalidParameterRegisterFlagIsEmpty()
            throws IOException {
        Map<String, String> map1 = new HashMap<String, String>();
        map1.put("billCode", "2Z9901001");
        map1.put("gameId", "SBXX");
     ...
     */
    @Test
    public void testRegisterMoveDeniedGameBillInvalidParameterRegisterFlagIsInvalidLetter()
            throws IOException {
        Map<String, String> map1 = new HashMap<String, String>();
        map1.put("billCode", "2Z9901001");
        map1.put("gameId", "SBXX");
    ...
    private MoveDeniedGameBill createMoveDeniedGameBill(String billCode,
            String gameId) {

        MoveDeniedGameBillPK pk = new MoveDeniedGameBillPK();
        pk.setBillCode(billCode);
        pk.setGameId(gameId);
        MoveDeniedGameBill c = new MoveDeniedGameBill();
        c.setPk(pk);
