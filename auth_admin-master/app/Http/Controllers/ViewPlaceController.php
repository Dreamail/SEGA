...
class ViewPlaceController extends Controller
{
     ...
     */
    public function view_place(Request $request) {

        $request->session()->forget('returnSearchType');
        return view('admin.view.place.find')
    ...
    public function data_search(Request $request) {
        ...
        switch ($request->input('searchType')) {
            ...
            case Config::get('const.VIEW_SEARCH_TYPE')['PHONE']:
                return $this->phone_search($request);
...
//                return redirect()->action('ReportSearchController@view');
     ...
     * @return $this
     */
    private function phone_search($request) {
