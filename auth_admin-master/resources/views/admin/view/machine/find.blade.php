            ...
            <div class="accordion-group">
                ...
                <div id="searchFormBody" class="accordion-body collapse in searchFormBody" style="background-color: #f5f5f5">
                    <div class="accordion-inner">
                        <form id="viewConfigOrderNuForm" class="form-horizontal" action="/admin/view/place/search" method="get">
                            <fieldset>
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select id="searchType" name="searchType">
                                            ...
                                            <option value="{{Config::get('const.VIEW_SEARCH_TYPE')['PHONE']}}" @if($searchType==Config::get('const.VIEW_SEARCH_TYPE')['PHONE']) selected @endif>{{Config::get('message.TYPE_PHONE')}}</option>
                    ...
                    <div id="machineDownloadOrderTableBody" class="accordion-body collapse in searchFormBody">
                        <div class="accordion-inner">
                            <table  class="table table-striped table-bordered">
                                <thead>
                                <tr>
                                    <th style="width: 65px">ALL.Net ID</th>
                                    <th style="width: 85px">店舗ID</th>
                                    <th style="width: 70px">店舗名</th>
                                    <th style="width: 70px">電話番号</th>
                                    <th style="width: 70px">郵便番号</th>
                                    <th style="width: 70px">ニックネーム</th>
                                    <th style="width: 70px">請求先コード</th>
